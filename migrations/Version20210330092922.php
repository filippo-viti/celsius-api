 ...
 */
final class Version20210330092922 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE observations (id INT AUTO_INCREMENT NOT NULL, time DATETIME NOT NULL, A_temp NUMERIC(4, 2) DEFAULT NULL, A_hum INT DEFAULT NULL, B_temp NUMERIC(4, 2) DEFAULT NULL, B_hum INT DEFAULT NULL, EXT_temp NUMERIC(4, 2) DEFAULT NULL, EXT_hum INT DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
